        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-6 text-gray-900 dark:text-[#EDEDEC]">
                    <form method="POST" action="{{ route('agent-sales.update', $agentSale) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <x-select-input id="credit_type_id" name="credit_type_id">
                                    ...
                                    @foreach ($creditTypes as $type)
                                        <option value="{{ $type->id }}"
                                            {{ old('credit_type_id', $agentSale->credit_type_id) == $type->id ? 'selected' : '' }}>
                                            {{ $type->name }}
                                        </option>
                                    @endforeach
                                </x-select-input>
                                ...
                                <x-select-input id="airline_id" name="airline_id">
                                    ...
                                    @foreach ($airlines as $airline)
                                        <option value="{{ $airline->id }}"
                                            {{ old('airline_id', $agentSale->airline_id) == $airline->id ? 'selected' : '' }}>
                                            {{ $airline->name }}
                                        </option>
                                    @endforeach
                                </x-select-input>
                            ...
                            <div>
                                ...
                                <x-select-input id="gds_id" name="gds_id">
                                    ...
                                    @foreach ($gdsList as $gds)
                                        <option value="{{ $gds->id }}"
                                            {{ old('gds_id', $agentSale->gds_id) == $gds->id ? 'selected' : '' }}>
                                            {{ $gds->name }}
                                        </option>
                                    @endforeach
                                </x-select-input>
                            ...
                            <div>
                                ...
                                <x-select-input id="pcc_id" name="pcc_id">
                                    ...
                                    @foreach ($pccs as $pcc)
                                        <option value="{{ $pcc->id }}"
                                            {{ old('pcc_id', $agentSale->pcc_id) == $pcc->id ? 'selected' : '' }}>
                                            {{ $pcc->code }}
                                        </option>
                                    @endforeach
                                </x-select-input>
                            ...
                            <div>
                                ...
                                <x-text-input id="pnr_number" name="pnr_number" type="text" class="mt-1 block w-full"
                                    :value="old('pnr_number', $agentSale->pnr_number)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="pax_name" name="pax_name" type="text" class="mt-1 block w-full"
                                    :value="old('pax_name', $agentSale->pax_name)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="amount" name="amount" type="text" class="mt-1 block w-full"
                                    :value="old('amount', $agentSale->amount)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="time_limit" name="time_limit" type="time" class="mt-1 block w-full"
                                    :value="old('time_limit', $agentSale->time_limit)" required />
                            ...
                            <div>
                                ...
                                <x-select-input id="visa_type_id" name="visa_type_id">
                                    ...
                                    @foreach ($visaTypes as $type)
                                        <option value="{{ $type->id }}"
                                            {{ old('visa_type_id', $agentSale->visa_type_id) == $type->id ? 'selected' : '' }}>
                                            {{ $type->types }}
                                        </option>
                                    @endforeach
                                </x-select-input>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-textarea-input id="comment" name="comment"
                                    rows="3">{{ old('comment', $agentSale->comment) }}</x-textarea-input>
